...
const Footer = () => {
  return (
    <div className="mt-20 text-lg">
      <div className="flex bg-cgray p-20">
        ...
        <div className="w-full space-y-4">
          ...
          <div className="flex gap-3 items-center">
            <input className="text-sm pl-7 rounded-xl bg-cdark w-1/2 py-4" type="text" placeholder="Enter your Email" />
      ...
      <div className="flex justify-center py-4 bg-cblue">
        <p className="font-semibold">© 2023 Copyright by PhoenEx. All rights reserved.</p>
      </div>
    </div>
  )
}
