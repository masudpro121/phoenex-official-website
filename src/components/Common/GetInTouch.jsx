...
const GetInTouch = () => {
  return (
    <div className="flex flex-col  lg:flex-row gap-20 lg:gap-0 items-center  py-5 w-3/4 m-auto my-20">
      <div className=" w-full space-y-5">
        <div className="text-center lg:text-start">
          <h2 className="font-bold text-3xl md:text-5xl leading-relaxed">Get in Touch for Inquiries and Feedback</h2>
