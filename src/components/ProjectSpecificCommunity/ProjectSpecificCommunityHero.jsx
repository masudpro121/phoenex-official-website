    ...
    <div className="m-20">
      <div className="flex items-center gap-20">
        <div className="w-full space-y-7">
          ...
          <p className="leading-[3] text-xl text-clightGray">Connect with pioneers in tech innovation. Discuss ideas, share insights, and shape the future.</p>
        ...
        <div className="w-full">
          <div className="flex justify-center gap-5 text-center">
            <div className="bg-cgray w-48 space-y-3 rounded-xl  p-7">
              <div className="flex justify-center"><Image className="w-20" src={HeroIcon1} /></div>
              <p>Total Members</p>
              <h2 className="text-5xl font-bold">24M</h2>
            </div>
            <div className="bg-cgray w-48 space-y-3 rounded-xl p-7">
            ...
            <div className="bg-cgray w-48 space-y-3 rounded-xl p-7">
              ...
              <h2 className="text-5xl font-bold">69</h2>
            </div>
          </div>
          <div className="p-7">
