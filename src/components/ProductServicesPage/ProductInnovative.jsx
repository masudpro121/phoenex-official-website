...
const ProductInnovative = () => {
  return (
    <div className="m-10 md:m-20">
      ...
      <div className="bg-cgray grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 p-7 rounded-xl my-10 text-center">
      ...
      <div className="flex flex-col-reverse md:flex-row  gap-20 items-center">
        <div className="w-full">
          <h2 className="text-4xl font-bold leading-loose text-center md:text-start">Empowering Learning and Knowledge Management</h2>
